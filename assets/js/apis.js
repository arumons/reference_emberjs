  ...
  properties: [
    {
      ...
      description: "Array like なオブジェクトからEmber.NativeArrayを生成します。通常は配列を作るだけで自動的にNativeArrayが生成されるため、このメソッドを使うのはEXTEND_PROTOTYPESがfalseの時だけでしょう。",
      arguments: [
                  {name: "arr",
    ...
    },
    {
      ...
      type: "クラスメソッド",
      head_description: "指定したプロパティにオブザーバを設定する。ここで設定したメソッドは値が変更される前に呼び出される。",
